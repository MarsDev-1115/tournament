...
<head>
    ...
    <title>Tournament Manager @isset($title)| {{ $title }} @endisset</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/frontend/vendor/simple-line-icons/css/simple-line-icons.min.css') }}">
</head>
...
<body>
    ...
    <script src="{{ asset('assets/frontend/js/optional/imagesloaded.pkgd.min.js') }}"></script>
    <script src="{{ asset('assets/frontend/js/optional/isotope.pkgd.min.js') }}"></script>
...
<!-- Mirrored from portotheme.com/html/porto_ecommerce/demo2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Oct 2021 13:14:32 GMT -->
</html>
