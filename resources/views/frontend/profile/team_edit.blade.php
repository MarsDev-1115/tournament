            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-10 p-5 box-shadow-4" style="border-radius: 10px;">
                    <div class="wizard mt-5 px-5">
                        ...
                        <form role="form" action="{{ route('profile.team.update', $team->id) }}" class="login-box" id="login-box" method="POST" enctype="multipart/form-data">
                            @csrf
              				@method('PUT')
                                ...
                                <div class="tab-pane active" role="tabpanel" id="step1">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-control form-select-lg" aria-label="Default select example" name="position">
                                                    ...
                                                    <option value="Coach" {{ $team->position == 'Coach'? 'Selected': '' }}>Coach</option>
                                                    <option value="Co-coach" {{ $team->position == 'Co-coach'? 'Selected': '' }}>Co-coach</option>
                                                    <option value="Manager" {{ $team->position == 'Manager'? 'Selected': '' }}>Manager</option>
                                                    <option value="Player" {{ $team->position == 'Player'? 'Selected': '' }}>Player</option>
                                                  </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="group" id="group1" value="H" @isset($team->group){{$team->group == "H" ? "checked": ""}}@endisset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control selectpicker" name="country" data-live-search="true">
                                                	@foreach($countries as $country)
                                              		<option value="{{$country->id}}" @if($country->id == $team->country) selected @endif>{{$country->name}}</option>
                                                  	@endforeach
                                                </select>
                                            </div>
                                        </div>
                                   ...
                                   <div class="row">
                                        <div class="col-md-12 text-center">
                                            @isset($team->image)<img src="{{ asset('team-img/' . $team->image) }}" id="profile" style="margin: 0 auto !important;">@endisset
                                        </div>
                                    </div>
                                    <div class="row">
