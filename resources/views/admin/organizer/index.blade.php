...
<div class="container-fluid">
    <div class="pl-5"><a href="#" style="color: #005B25; font-size: 20px; font-weight: 700;"><i class="sicon-home"></i> &nbsp;> Organizers</a></div>
</div>
<div class="container-fluid">
    <div class="row">
            ...
            <div class="row mt-5">
                            ...
                            <table class="w-100">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td >
                                            <div class="d-flex justify-content-between py-1 pl-2 pr-5" style="border: 1px solid #E8E8E8;">
                                                <div class="d-flex">
                                                    <img src="{{ asset('assets/img/demo_avatar.png')}}" width="50px" />
                                                    <div class="pl-2">
                                                        <div style="color: #2B503D; font-size: 15px; font-weight: 700;">Danny Berdsen</div>
                                                        <div style="color: #555555; font-size: 8px; font-weight: 500;">Team: Borussia M.,  +48 765 432 100</div>
                ...
                <div class="col-md-8 text-right  pl-5">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box-shadow-4 w-100 p-4 mb-3">
                                <div class="d-flex justify-content-between">
                                    <div class="d-flex">
                                        <img src="{{ asset('assets/img/demo_avatar.png') }}" width="90" />
                                        <div class="pl-3 w-100">
                                            <div class="d-flex">
                                                <div class="pr-3 recent-registered">
                                                    Danny Berdsen
                                                </div>
                                                <div class="pl-3 pt-1 recent-reg-title">
                                                    Legia Warszawa
                                                </div>
                                            </div>
                                            <div class="d-flex justify-content-between">
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-md-12">
                            <h4 class="text-left" style="color: #1BD741; font-size: 30px; font-weight: 700;">All Organizers</h4>
                            <div class="box-shadow-4 w-100 p-4 mb-3">
                                <div class="d-flex justify-content-between">
                                    <div class="d-flex">
                                        <img src="{{ asset('assets/img/demo_avatar.png') }}" width="90" />
